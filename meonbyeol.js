...
/* ---------- 표정 (첨부 face pack 그대로 · 몸체는 기존 그림 유지) ---------- */
var EXPRS=[['normal','기본'],['smile','활짝'],['focus','집중'],['sleepy','졸림'],['surprised','깜짝'],['sad','시무룩'],['proud','뿌듯'],['shy','수줍']];
function byeolFace(expression,opts){opts=opts||{};var dusty=!!opts.dusty,gs=opts.glassesStroke||'#6B5E77',showGlasses=!!opts.showGlasses||expression==='focus';
  var eyes=expression==='smile'?'<path d="M68 101 q7 -6 14 0" stroke="#5E5468" stroke-width="4.1" fill="none" stroke-linecap="round"/><path d="M112 101 q7 -6 14 0" stroke="#5E5468" stroke-width="4.1" fill="none" stroke-linecap="round"/>'
  :expression==='focus'?'<ellipse cx="78" cy="100" rx="6.4" ry="8" fill="#5E5468"/><ellipse cx="122" cy="100" rx="6.4" ry="8" fill="#5E5468"/><circle cx="80" cy="99" r="1.8" fill="#fff"/><circle cx="120" cy="99" r="1.8" fill="#fff"/><path d="M75 93 L87 96 M125 93 L113 96" stroke="#5E5468" stroke-width="2.2" stroke-linecap="round" opacity=".82"/>'
  :expression==='surprised'?'<circle cx="79.5" cy="100" r="6.2" fill="#5E5468"/><circle cx="120.5" cy="100" r="6.2" fill="#5E5468"/><circle cx="82.5" cy="99.5" r="1.6" fill="#FFF"/><circle cx="120.5" cy="99.5" r="1.6" fill="#FFF"/><path d="M70 90 q9 -6 18 0 M112 90 q9 -6 18 0" stroke="#5E5468" stroke-width="2.2" fill="none" stroke-linecap="round" opacity=".8"/>'
  :expression==='sleepy'?'<path d="M70 100 q8 4 16 0" stroke="#5E5468" stroke-width="3.6" fill="none" stroke-linecap="round"/><path d="M114 100 q8 4 16 0" stroke="#5E5468" stroke-width="3.6" fill="none" stroke-linecap="round"/><path d="M66 93 q7 -2 14 0 M120 93 q7 -2 14 0" stroke="#5E5468" stroke-width="1.8" fill="none" stroke-linecap="round" opacity=".45"/>'
  :expression==='sad'?'<ellipse cx="79" cy="101" rx="5.5" ry="7" fill="#5E5468"/><ellipse cx="121" cy="101" rx="5.5" ry="7" fill="#5E5468"/><path d="M66 95 q6 -4 12 -1 M113 93 q6 -3 12 1" stroke="#5E5468" stroke-width="2" fill="none" stroke-linecap="round" opacity=".7"/>'
  :expression==='proud'?'<ellipse cx="79" cy="100" rx="5.6" ry="7.2" fill="#5E5468"/><ellipse cx="121" cy="100" rx="5.6" ry="7.2" fill="#5E5468"/><circle cx="80.5" cy="98.7" r="1.35" fill="#fff"/><circle cx="122.2" cy="98.7" r="1.35" fill="#fff"/><path d="M72 94 q7 -2 14 0 M114 94 q7 -2 14 0" stroke="#5E5468" stroke-width="1.8" fill="none" stroke-linecap="round" opacity=".6"/>'
  :expression==='shy'?'<ellipse cx="79" cy="101" rx="5.4" ry="7" fill="#5E5468"/><ellipse cx="121" cy="101" rx="5.4" ry="7" fill="#5E5468"/><circle cx="80.6" cy="99.4" r="1.4" fill="#fff" opacity=".85"/><circle cx="121.9" cy="99.4" r="1.4" fill="#fff" opacity=".85"/>'
  :'<ellipse cx="79" cy="101" rx="5.8" ry="7.5" fill="#5E5468"/><ellipse cx="121" cy="101" rx="5.8" ry="7.5" fill="#5E5468"/><circle cx="80.8" cy="99.5" r="1.45" fill="#fff"/><circle cx="122.1" cy="99.5" r="1.45" fill="#fff"/>';
  var mouth=expression==='surprised'?'M100 111 a4.2 5.2 0 1 0 .1 0':expression==='sad'?'M94 118 Q100 112 106 118':expression==='sleepy'?'M97 115 q3 1.5 6 0':expression==='shy'?'M96 114 q4 3 8 0':expression==='proud'?'M94 112 Q100 119 106 112':expression==='smile'?'M92 111 Q100 120 108 111':expression==='focus'?'M95 113 Q100 116 105 113':'M95 113 Q100 117 105 113';
  var bo=expression==='shy'?'.95':dusty?'.3':'.7';
  var gl=showGlasses?'<g><circle cx="81" cy="102" r="9.5" fill="none" stroke="'+gs+'" stroke-width="2.6"/><circle cx="119" cy="102" r="9.5" fill="none" stroke="'+gs+'" stroke-width="2.6"/><line x1="90.5" y1="101" x2="109.5" y2="101" stroke="'+gs+'" stroke-width="2.6"/></g>':'';
  return '<g class="monbyeol-face" data-expression="'+expression+'">'+eyes+'<ellipse cx="69" cy="114" rx="7.5" ry="4.5" fill="#F7C8D8" opacity="'+bo+'"/><ellipse cx="131" cy="114" rx="7.5" ry="4.5" fill="#F7C8D8" opacity="'+bo+'"/><path d="'+mouth+'" stroke="#5E5468" stroke-width="3" fill="none" stroke-linecap="round"/>'+gl+'</g>';}
...
/* ---------- 먼돌이 (원본 몸·헤드폰·질감 그대로 + 표정) ---------- */
var DOLN=0;
function dolFace(ex){var brow=ex==='focus'?'<path d="M42 52 l12 2" stroke="#5E5468" stroke-width="2" stroke-linecap="round"/><path d="M66 54 l12 -2" stroke="#5E5468" stroke-width="2" stroke-linecap="round"/>':ex==='sad'?'<path d="M40 54 q4 -4 10 -2" stroke="#5E5468" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M70 52 q5 -3 10 1" stroke="#5E5468" stroke-width="2" fill="none" stroke-linecap="round"/>':ex==='surprised'?'<path d="M40 50 q6 -6 12 -1" stroke="#5E5468" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M68 50 q6 -5 12 0" stroke="#5E5468" stroke-width="2" fill="none" stroke-linecap="round"/>':'';
  var eyes=ex==='sleepy'?'<path d="M44 58 q5 3 10 0" stroke="#5E5468" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M66 58 q5 3 10 0" stroke="#5E5468" stroke-width="3" fill="none" stroke-linecap="round"/>':ex==='smile'||ex==='proud'&&false?'<path d="M43 58 q5 -4 10 0" stroke="#5E5468" stroke-width="3.4" fill="none" stroke-linecap="round"/><path d="M67 58 q5 -4 10 0" stroke="#5E5468" stroke-width="3.4" fill="none" stroke-linecap="round"/>':ex==='surprised'?'<circle cx="49" cy="58" r="4" fill="#5E5468"/><circle cx="71" cy="58" r="4" fill="#5E5468"/><circle cx="50" cy="57" r="1" fill="#fff"/><circle cx="72" cy="57" r="1" fill="#fff"/>':ex==='focus'?'<ellipse cx="49" cy="58" rx="4" ry="5" fill="#5E5468"/><ellipse cx="71" cy="58" rx="4" ry="5" fill="#5E5468"/><circle cx="50" cy="57" r="1" fill="#fff"/><circle cx="72" cy="57" r="1" fill="#fff"/>':'<line x1="44" y1="58" x2="55" y2="58" stroke="#5E5468" stroke-width="4" stroke-linecap="round"/><line x1="66" y1="58" x2="77" y2="58" stroke="#5E5468" stroke-width="4" stroke-linecap="round"/>';
  var mouth=ex==='surprised'?'<circle cx="60" cy="69" r="3.6" fill="none" stroke="#5E5468" stroke-width="2.7"/>':ex==='sad'?'<path d="M54 72 q6 -5 12 0" stroke="#5E5468" stroke-width="3" fill="none" stroke-linecap="round"/>':ex==='proud'?'<path d="M54 67 q6 5 12 0" stroke="#5E5468" stroke-width="3.2" fill="none" stroke-linecap="round"/>':ex==='shy'?'<path d="M55 68 q5 4 10 0" stroke="#5E5468" stroke-width="2.8" fill="none" stroke-linecap="round"/>':ex==='sleepy'?'<path d="M56 69 q4 2 8 0" stroke="#5E5468" stroke-width="2.8" fill="none" stroke-linecap="round"/>':'<path d="M56 68 q4 3 8 0" stroke="#5E5468" stroke-width="3" fill="none" stroke-linecap="round"/>';
  var bo=ex==='shy'?'.95':ex==='sad'?'.45':'.7';
  var gl=ex==='focus'?'<g><circle cx="49" cy="58" r="8" fill="none" stroke="#5E5468" stroke-width="2.3"/><circle cx="71" cy="58" r="8" fill="none" stroke="#5E5468" stroke-width="2.3"/><line x1="57" y1="58" x2="63" y2="58" stroke="#5E5468" stroke-width="2.3"/></g>':'';
  return brow+eyes+mouth+'<circle cx="38" cy="66" r="4.5" fill="#F7C8D8" opacity="'+bo+'"/><circle cx="82" cy="66" r="4.5" fill="#F7C8D8" opacity="'+bo+'"/>'+gl;}
function dolSVG(o){o=o||{};var id='mbdol'+(++DOLN),hp=o.headphone===true,ex=o.expr||'normal';
  var extra=ex==='proud'?'<path d="M100 18 l2.2 4.6 5 .7 -3.6 3.5 .9 5 -4.5 -2.4 -4.5 2.4 .9 -5 -3.6 -3.5 5 -.7z" fill="#F2D278"/>':ex==='surprised'?'<path d="M102 16 v10" stroke="#A894D0" stroke-width="3" stroke-linecap="round"/><circle cx="102" cy="31" r="1.8" fill="#A894D0"/>':'';
  return '<svg class="mb-dol" viewBox="0 0 120 110" aria-hidden="true"><defs><filter id="'+id+'"><feTurbulence type="fractalNoise" baseFrequency="0.06" numOctaves="3" seed="21" result="n"/><feDisplacementMap in="SourceGraphic" in2="n" scale="2.6"/></filter></defs><g filter="url(#'+id+')">'+
  '<path d="M60 16 q34 0 40 34 q4 30 -18 40 q-22 10 -44 0 q-22 -10 -18 -40 q6 -34 40 -34 z" fill="#D8D2E2" stroke="#A79BB4" stroke-width="4" stroke-linejoin="round"/><ellipse cx="44" cy="34" rx="9" ry="5" fill="#EAE6F0" opacity=".9"/>'+dolFace(ex)+
  (hp?'<path d="M24 42 Q60 0 96 42" stroke="#A894D0" stroke-width="6.5" fill="none" stroke-linecap="round"/><path d="M24 42 Q60 3 96 42" stroke="#C8B8E8" stroke-width="3" fill="none" stroke-linecap="round"/><rect x="13" y="38" width="15" height="22" rx="7.5" fill="#C8B8E8" stroke="#A894D0" stroke-width="2.5"/><rect x="92" y="38" width="15" height="22" rx="7.5" fill="#C8B8E8" stroke="#A894D0" stroke-width="2.5"/><rect x="16.5" y="42" width="8" height="14" rx="4" fill="#E8DFF5"/><rect x="95.5" y="42" width="8" height="14" rx="4" fill="#E8DFF5"/><circle cx="20" cy="45" r="1.5" fill="#FFF" opacity=".8"/>':'')+
  '</g>'+extra+((o.gearList||[]).map(function(g){return GEAR[g]&&GEAR[g].d||'';}).join(''))+'<ellipse cx="60" cy="98" rx="34" ry="6" fill="#D9CBEE" opacity=".5"/></svg>';}
