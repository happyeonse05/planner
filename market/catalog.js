...
var products=[
  ...
  official({id:'pack-certificate',category:'examPack',productType:'functionalPack',name:'자격증 · 어학 팩',description:'영역별 진도와 회독, 기출·모의시험 점수를 기록해 다음 공부 영역을 바로 확인해요.',price:P.functionPack,tags:['자격증','토익','어학'],thumbnail:{colors:['#e8f4ef','#dbe7f7','#fff','#55746a']},payload:{packKey:'certificate'}}),
  ...
  official({id:'pack-content',category:'creatorPack',productType:'functionalPack',name:'콘텐츠 파이프라인 CORE',description:'아이디어 → 대본 → 촬영 → 편집 → 업로드 상태를 빠르게 관리하는 크리에이터 기본팩. 씬·대사 관리는 스크립트 확장팩에서 더해요.',price:P.functionPack,tags:['유튜브','콘텐츠','크리에이터'],thumbnail:{colors:['#f7e5e8','#f5e9d7','#e6eef6','#765f66']},payload:{packKey:'content'}}),
  ...
  official({id:'pack-creator-script',category:'creatorPack',productType:'functionalPack',name:'스크립트 제작 확장팩',description:'콘텐츠 파이프라인 CORE에 씬별 구성·대사·자막·촬영 준비·편집 체크를 더하는 제작 특화 확장팩.',price:P.premiumPack,tags:['유튜브','숏폼','대본','칸반'],thumbnail:{colors:['#f5e4e8','#eee6f5','#e3edf7','#735f74']},payload:{packKey:'creatorScript'}}),
