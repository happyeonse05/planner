function nemoSVG(mood,cls){
  ...
  if(m==='happy'){
    ...
    face='<path d="M27 40 L39 39" fill="none" stroke="#5a4033" stroke-width="4.2" stroke-linecap="round"/><path d="M53 39 L65 40" fill="none" stroke="#5a4033" stroke-width="4.2" stroke-linecap="round"/><circle cx="46" cy="49" r="3.8" fill="none" stroke="#5a4033" stroke-width="3.8"/><circle cx="6.5" cy="10" r="2.4" fill="none" stroke="#b98e70" stroke-width="2.7"/><circle cx="-2.5" cy="20" r="3.2" fill="none" stroke="#b98e70" stroke-width="2.9"/>';
  }else{
