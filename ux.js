...
function decorateEmpties(){
  ...
  candidates.forEach(function(el){
    ...
    el.dataset.uxDone='1';
    el.innerHTML='<span class="ux-empty-wrap"><span class="ux-face '+mood+'"><i class="ux-mouth"></i></span><span class="ux-empty-text">'+esc(text)+'</span></span>';
  });
}
